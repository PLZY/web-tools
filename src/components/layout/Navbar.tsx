      ...
      <div className="container mx-auto flex h-14 items-center justify-between px-4">
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center space-x-2 group">
            ...
            >
              <JumpingDog className="w-7 h-7" />
            </motion.div>
            <span className="font-extrabold sm:inline-block text-lg tracking-tight bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
              DogUp
            </span>
          </Link>
